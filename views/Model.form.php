<? $this->displayView('components/header.php'); ?>
			<h1>
				<a href="<? echo $this->getApplication()->getConfiguration('cheeseUrl') . $ObjectName; ?>/index" title="<? echo $ObjectName; ?>"><? echo $this->localize($ObjectName); ?></a>&ensp;&raquo;&ensp;<? echo $this->localize(ucfirst($mode)); ?>
